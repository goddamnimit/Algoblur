...
import { LogIn, LogOut, Shield, Info, Zap, Target, Database, RefreshCw, ShoppingBag, Globe } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 selection:bg-emerald-500 selection:text-zinc-950">
      ...
      <main className="max-w-5xl mx-auto p-4 md:p-8">
        ...
        <Tabs defaultValue="swipe" className="w-full">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 bg-zinc-900 border-2 border-zinc-800 p-1 mb-8 h-auto">
